...
My inbox receives many messages from engineers and aspiring academics. They ask about the application process, research committee expectations, and daily laboratory life. 

![msg](msg.png)

I compiled this guide to explain the logistics and expectations. It shows how the system functions internally, drawing from my transition from engineering to academia and conversations with candidates across UM6P research centers.

## My personal journey: from engineering to multi-agent RL

I graduated from ENSIAS Rabat as an AI Research Engineer. During my fourth year, I published a peer reviewed co-authored machine learning paper applied to climate data analysis in a Springer volume (come [here](https://hambam.top/academia/publications/#2024) for more details). That publication taught me how research works: from literature review to experimental design, data collection, and analysis. It also showed me the importance of collaboration and mentorship in producing high quality research.

For my engineering capstone project, I completed a research internship at the AI Movement center working on deep reinforcement learning for collaborative target acquisition and coverage optimization in satellite constellations. I trained RL agents to coordinate satellite clusters for Earth observation data collection. It was the kind of project sitting at the intersection of advanced AI and real world applications. (see more details in my [portfolio](https://hambam.top/cv/work-experience/#ai-research-engineer)).
...
![doctoraldays2025](/assets/images/gallery/doctoral_days_2025.jpeg)
*from the Doctoral Days 2025, I was presenting our survey on adversarial multi-agent reinforcement learning.*
...
### [The College of Computing (CC)](https://cc.um6p.ma/)

![college_of_computing](/assets/images/gallery/cc.jpg)
...
### [The AI Movement center](https://aim.um6p.ma/)

![aim](/assets/images/gallery/aim.jpg)
...
### [The Moroccan Center for Game Theory (MCGT)](https://mcgt.um6p.ma/)
...
* Distributed Computing Projects: [Projet_DC](https://github.com/HamBa%252Dm/Projet_DC).


* The Dining Philosophers Concurrency Problem: [dining philosophers](https://github.com/HamBa%252Dm/dining%252Dphilosophers).


* High Frequency Graph Computations: [HFGC](https://hambam.top/cv/projects/#hierarchical-fuzzy-graph-coloring-algorithm).


* Adaptive Boids Simulation Swarms: [adaptive boids](https://hambam.top/cv/projects/#flocking-birds-simulation).
...
![graphs](/assets/images/gallery/lab_board.jpg)
*just me and my peers Chaimae and Mehdi trying to figure things out in the workspace for the graph theory project..*
...
![um6p_benguerir](/assets/images/gallery/bngrir.jpg)
*from the main campus in Benguerir*
...
![train_station](/assets/images/gallery/oncf_bngrir.jpg)
*the new train station in Benguerir.*
...
![science_week](/assets/images/gallery/science_week_2026.jpg)
*from the Science Week 2026 conference on AI, with my undergraduate friend Abdelmounain Bounite.*

This insistence on publishing excellence is a primary reason why the university consistently positions itself within the top 400 universities globally in recognized international rankings ([source](https://um6p.ma/um6p-ranked-among-top-400-global-universities-rankings-2026)), giving your degree significant weight worldwide.
